...
Configures all the relevant data for a particular tenant/household/individual.
  ...
  * <strong>Contribution</strong> <br/>
  ...
  <em>Note: Selecting a <b>Sharing Type</b> will use the relavant amount from either <b>Option - Non Metered</b> or <b>Option - Metered (Sub Meter)/Sub Meter Adjustment</b></em>
  ...
  * <strong>Option - Metered (Sub-Meter)</strong> <br/>
  ...
  <em>Note: The specific Sub-Meter sheet for this particular individual must be present/linked, and contains the relevant sub-meter reading.</em>
  ...
  * <strong>Sub Meter Adjustment</strong> <br/>
  ...
  <strong>How does it work?</strong>
    1. It works by getting the daily avarage consumption from the available reading data. <br/>
